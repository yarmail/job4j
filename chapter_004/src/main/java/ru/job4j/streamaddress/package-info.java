 ...
 * При решении задания нужно использовать Stream API, метод map, метод collect(Collections.toList());
 ...
 * );
 *
 * Важно. чтобы сравнить объекты класса Address нужно в этом классе определить два метода
 * equals hashCode.
 *
