...
public class Chess extends Application {
    ...
    private Rectangle buildFigure(int x, int y, int size, String image) {
        ...
        /**
         * Вероятно:
         * Движение происходит, когда кнопка отпущена
         * momento - текущие координаты фигуры
         * "if (logic.move" - если можно двигать
         */
    ...
    /**
     * Метод Add добавляет все фигуры на доску (см. выше)
     * this.logic - создается объект типа Logic
     * this.logic.add - во внутренний массив Logic добавляется объект
     * типа Figure
     * например index 0; PawnBlack(Cell.A7)
     * @param figure
     * @param grid
     */
